    ...
    <>
      ...
      <div className="guitars-container">
        ...
        <ul>
          ...
          <li>
            2020 'Montana' Telecaster with Monty's Telecaster Pickups in Walnut
          </li>
          <li>2020 Thorp Special DC Les Paul Custom with P90s 2005 (ish)</li>
          <li>
            Shed/Handmade ‘Brender’ Weirdo Guitar in Forest Green (p90 and coil
            tapped PAF)
          </li>
        </ul>
        <ul>
