    ...
    <>
      ...
      <div className="history-container">
        ...
        <p>
          ...
          pair were inseparable and spent most of their time together chatting
          about recording. microphones, bands, amps; everything music related.
          It was only natural that the conversation would move on to opening a
          studio together and in 2014, it very nearly happened.
          <br></br>
          <br></br>
      ...
      <div className="services-container">
        ...
        <p>
          ...
          Get in touch to discuss your project. We're usually game for anything
          so if you've got something off the beaten track to talk through,
